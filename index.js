...
const SUB_PATH = process.env.SUB_PATH || 'todolist';
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;
const UUID = process.env.UUID || '9afd1339-b893-40c1-84dd-51e7ce204913';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '';
const ARGO_AUTH = process.env.ARGO_AUTH || '';
const ARGO_PORT = process.env.ARGO_PORT || 8082;            
const CFIP = process.env.CFIP || 'store.ubi.com';              
const CFPORT = process.env.CFPORT || 443;                   
const NAME = process.env.NAME || 'todo-list';                        
